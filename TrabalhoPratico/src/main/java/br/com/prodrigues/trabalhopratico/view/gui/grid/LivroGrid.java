...
public class LivroGrid extends javax.swing.JDialog {
    ...
    public static LivroGrid getInstance(Frame parent, boolean modal, IControleSimples controle) {
        if (tela == null) {
     ...
     * @param controle
     */
    private LivroGrid(java.awt.Frame parent, boolean modal, IControleSimples controle) {
        super(parent, modal);
