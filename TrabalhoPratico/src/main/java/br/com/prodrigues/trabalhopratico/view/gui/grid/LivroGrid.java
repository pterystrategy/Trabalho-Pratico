...
public class LivroGrid extends javax.swing.JDialog {
    ...
    public static LivroGrid getInstance(java.awt.Frame parent, boolean modal , IControleSimples controle) {
        if (tela == null){
            ...
            */
            ...
            //</editor-fold>
            //</editor-fold>
            return new LivroGrid(parent, modal, controle);
        }else
            return tela;
    } 
    ...
    /**
     * Creates new form LivroGrid
     * @param parent
     * @param modal
     * @param controle
     */
    public LivroGrid(java.awt.Frame parent, boolean modal, IControleSimples controle) {
        super(parent, modal);
        this.controle = controle;
        this.model = new LivroTableModel(controle.getAll());
        initComponents();
    }
